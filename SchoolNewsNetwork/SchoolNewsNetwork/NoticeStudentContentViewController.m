//
//  NoticeStudentContentViewController.m
//  SchoolNewsNetwork
//
...
@interface NoticeStudentContentViewController ()<UIWebViewDelegate>

@end

@implementation NoticeStudentContentViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self setTheTitle:@"评语内容"];
